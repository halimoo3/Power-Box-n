...
export function ReviewsForm() {
  ...
  const updateSectionField = (field: keyof Omit<ReviewsData, 'reviews'>, value: string) => {
      ...
      >
        <div className="space-y-6">
          ...
          <TextField
            ...
            onChange={(value) => updateSectionField('sectionDescription', value)}
          ...
          <TextField
            ...
            onChange={(value) => updateSectionField('trustIndicatorText', value)}
          ...
          >
            <div className="space-y-6">
              ...
              <div className="mt-6 p-4 border rounded-lg bg-gray-50">
                ...
                <div className="flex-shrink-0 w-72 bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-xl p-5 border-2" style={{ borderColor: "#007BFF" }}>
                  {/* Quotation Mark Icon */}
        ...
        <div className="bg-gray-50 rounded-2xl p-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              {reviewsData.sectionDescription || "Section description goes here"}
            </p>
          </div>
          ...
          <div className="flex gap-4 overflow-x-auto pb-4">
            {reviewsData.reviews.slice(0, 6).map((review, index) => (
              <div key={index} className="flex-shrink-0 w-72 bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-xl p-5 border-2" style={{ borderColor: "#007BFF" }}>
                <div className="flex justify-center mb-3">
                  <div className="bg-blue-100 rounded-full p-2">
                    <Quote className="h-5 w-5 text-blue-600" />
                  </div>
