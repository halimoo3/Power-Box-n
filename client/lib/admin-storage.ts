    ...
    reviews: [
      {
        id: "1",
        name: "Sarah Johnson",
        photo: "https://images.unsplash.com/photo-1494790108755-2616b612b1-1b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80",
        rating: 5,
    ...
    if (stored) {
      ...
      return {
        ...
        featuresSection: { 
          ...
          features: parsed.featuresSection?.features || defaultAdminData.featuresSection.features
        },
        ...
        finalCta: { 
          ...
          ...parsed.finalCta,
          benefits: parsed.finalCta?.benefits || defaultAdminData.finalCta.benefits,
          trustBarItems: parsed.finalCta?.trustBarItems || defaultAdminData.finalCta.trustBarItems
        },
        footer: { 
          ...defaultAdminData.footer, 
          ...parsed.footer,
          socialLinks: parsed.footer?.socialLinks || defaultAdminData.footer.socialLinks
        }
      };
    }
  } catch (error) {
